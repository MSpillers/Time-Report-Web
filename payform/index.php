...
<html>
    <head>
        ...
        <?php
            ...
            echo "Pay Period Number : {$row[0]} Payperiod Start Date: {$row[1]} Payperiod End Date: {$row[2]} Payperiod Active: {$row[3]} Payperiod Conversion: {$row[4]}";
                echo "<br />\n";
            }*/
            ...
            while($row = pg_fetch_row($active_pay_period)){
                ...
                $payperiod_str = $row[1];
                $payperiod_end = $row[2];
                $payperiod_active = boolval($row[3]);
                $payperiod_conv = floatval($row[4]);
            }
            ...
            $_SESSION['conversion'] = $payperiod_conv;
            $_SESSION['payperiod_str'] = $payperiod_str;
            $_SESSION['payperiod_end'] = $payperiod_end;
            ...
            <div id="form-top">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="number" id="ID" name="ID" min="902000000">
                    </li>
                    <li>
                    ...
                    <li>
                        <label for="RCV-COMP-TIME">Receive Compensatory Time: </label>
                        <label for="RCV-COMP-TIME">Yes</label>
                        <input type="radio" id="RCV-COMP-TIME" name="RCV-COMP-TIME" value="Yes">
                        <label for="RCV-COMP-TIME">No</label> 
                        <input type="radio" id="RCV-COMP-TIME" name="RCV-COMP-TIME" value="No">
                    </li>
                </ul>
            </div>
            <div class="form-body" >
